...
def decoder_stack(input_layer, encoder_layers):
    layers = [input_layer]
...
def create_generator(generator_inputs):
    ...
    with tf.variable_scope("decoder_stack_normal"):
        feature_normal = decoder_stack(z_normal,encoder_layers=layers)
    ...
    with tf.variable_scope("decoder_stack_albedo"):
        feature_albedo = decoder_stack_with_skip(z_albedo, encoder_layers=layers)
